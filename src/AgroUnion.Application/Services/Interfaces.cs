...
public interface IAgroUnionService
{
    ...
    Task<string> ResetPasswordAsync(string userId, string adminUserId, CancellationToken ct = default);
    Task ChangeUserRoleAsync(string userId, string role, string adminUserId, CancellationToken ct = default);
    ...
    Task SetUserActiveAsync(string userId, bool active, string adminUserId, CancellationToken ct = default);
    Task UpdateAdminUserAsync(AdminUserUpdateRequest request, string adminUserId, CancellationToken ct = default);
    Task DeletePersonalDataAsync(string userId, string adminUserId, CancellationToken ct = default);
    Task SavePlatformConfigurationAsync(PlatformConfigurationRequest request, string adminUserId, CancellationToken ct = default);
    Task<string> ExportAuditLogCsvAsync(CancellationToken ct = default);
