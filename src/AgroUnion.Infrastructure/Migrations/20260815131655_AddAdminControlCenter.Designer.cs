...
namespace AgroUnion.Infrastructure.Migrations
{
    ...
    [Migration("20260815131655_AddAdminControlCenter")]
    partial class AddAdminControlCenter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroUnion.Domain.Entities.PlatformConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<bool>("AllowProfileEditing")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("ApplicationPauseMessage")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");
                    ...
                    b.Property<string>("DefaultAccountManager")
                        .IsRequired()
                        .HasMaxLength(180)
                        .HasColumnType("varchar(180)");
            ...
            modelBuilder.Entity("AgroUnion.Domain.Entities.UserPortalPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<bool>("CompactDashboard")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.ToTable("UserPortalPreferences");
                });
