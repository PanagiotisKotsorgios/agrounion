...
The following locally stored images are used on the public website:
...
- `hero-network-harvest.jpg` — [Unsplash image supplied for the homepage hero slideshow](https://images.unsplash.com/photo-1563201515-adbe35c669c5)
...
- `gallery-receiving.jpg` — [Bernd Dittrich / Unsplash](https://unsplash.com/photos/a-forklift-driving-through-a-warehouse-filled-with-pallets-F2C_mSrb6iM)
- `gallery-fieldwork.jpg` — [Gustavo Fring / Pexels](https://www.pexels.com/photo/a-man-standing-with-a-notepad-in-a-field-4975400/)

Each asset was downloaded from a page marked free to use under the respective Unsplash or Pexels license.
